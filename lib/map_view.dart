...
class _MapViewState extends State<MapView> {
  ...
  CameraPosition _initialPosition = CameraPosition(target: LatLng(19.4315518,-99.1344247));
  ...
  Future<void> _goToMexicoCity() async {
    double lat = 19.4315518;
    double long = -99.1344247;
